/**************************************************************************
*  File     :  lcd4s.h                                                    *
*  Summary  :  Funcions for HD44780 LCD's drived by VLSI VS1005 chips     *
*  Version  :  1.0                                                        *
*  Date     :  25.10.2020                                                 *
...
*   CPU: VLSI VS1005G                                                     *
*   Developper board VLSI VS1005 BREAKOUT BOARD  v1.0.5                   *
*  Description:                                                           *
*   Funcions for  LCD's with Hitachi HD44780 drivers                      *
*   Uses interface 4 bit,                                                 *
**************************************************************************/

#ifndef _lcdvs_h_
#define _lcdvs_h_ true

#include <vstypes.h>   // types and macro deffinitions: typedef unsigned short u_int16; USEY
...
void textscroll(u_int16 display, char *text, u_int16 line, u_int16 positions, u_int16 *scposi);  // textscroll - scrolls text in one line
